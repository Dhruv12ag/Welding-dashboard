-- AlterTable
ALTER TABLE `alerts` ADD COLUMN `durationMs` BIGINT NULL;

-- AlterTable
ALTER TABLE `machines` MODIFY `maxCurrent` DOUBLE NULL DEFAULT 200,
    MODIFY `maxVoltage` DOUBLE NULL DEFAULT 40;
